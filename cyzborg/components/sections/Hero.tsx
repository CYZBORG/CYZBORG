...
const Hero: React.FC = () => {
  ...
  return (
    <section 
      id={SectionIds.HERO} 
      className="relative h-[100svh] md:h-screen min-h-[600px] w-full bg-white dark:bg-cyzborg-black overflow-hidden flex items-end pb-4 md:pb-0 md:items-center"
    >
      {/* Background Image (Covering the entire screen) */}
      <div 
        className="absolute inset-0 z-0 bg-cover bg-no-repeat bg-[position:73.5%_top] sm:bg-[position:75%_top] md:bg-[position:85%_top] lg:bg-[position:75%_top] xl:bg-[position:80%_top]"
        style={{ 
      ...
      <div className="absolute inset-x-0 bottom-0 h-32 z-0 bg-gradient-to-t from-transparent dark:from-cyzborg-black to-transparent pointer-events-none"></div>

      {/* Content Container positioned to the left */}
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 pt-20 md:pt-48 lg:pt-56 flex flex-col justify-center">
        ...
        <h1 className="flex flex-col font-display font-bold uppercase leading-[0.9] text-left drop-shadow-[0_10px_20px_rgba(0,0,0,0.8)]">
          <span className="relative inline-block max-w-min">
            ...
            <span className="text-[4rem] sm:text-[4.5rem] md:text-[5rem] lg:text-[5.5rem] xl:text-[7.5rem] 2xl:text-[9.5rem] text-transparent bg-clip-text bg-gradient-to-tr from-[#999999] via-[#E8E8E8] to-[#555555] block tracking-normal max-w-min" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.1)' }}>
              AUGMENTED
            </span>
          </span>
          <span className="text-[4rem] sm:text-[4.5rem] md:text-[5rem] lg:text-[5.5rem] xl:text-[7.5rem] 2xl:text-[9.5rem] text-transparent bg-clip-text bg-gradient-to-tr from-[#999999] via-[#E8E8E8] to-[#555555] block tracking-normal max-w-min" style={{ WebkitTextStroke: '1px rgba(255,255,255,0.1)' }}>
        ...
        <div className="mt-6 md:mt-8 mb-10 flex flex-col gap-2">
          <p className="font-sans text-neutral-300 text-xl md:text-2xl lg:text-3xl uppercase tracking-[0.2em] font-medium">
            MORE THAN HUMAN,<br className="block md:hidden" /><span className="hidden md:inline"> </span>BETTER THAN MACHINE.
          </p>
          <p className="font-sans text-neutral-400 text-base md:text-lg lg:text-xl uppercase tracking-[0.2em] font-medium">
