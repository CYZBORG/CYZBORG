  ...
  return (
    ...
    >
      ...
      <img 
        ...
        alt="" 
        className="absolute top-1/4 -left-[30%] md:-left-[10%] w-[80%] md:w-[40%] opacity-[0.03] -rotate-90 pointer-events-none select-none z-0"
      />
      <img 
        src="https://helmet-with-logo.netlify.app/cyzborg-leds-logo.svg" 
        alt="" 
        className="absolute bottom-1/4 -right-[30%] md:-right-[10%] w-[80%] md:w-[40%] opacity-[0.02] rotate-45 pointer-events-none select-none z-0"
      />
