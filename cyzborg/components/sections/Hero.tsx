...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div 
        className="absolute inset-0 z-0 bg-cover bg-no-repeat bg-[position:73.5%_top] sm:bg-[position:75%_top] md:bg-[position:65%_top] lg:bg-[position:75%_top] xl:bg-[position:80%_top]"
        style={{ 
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-12 lg:px-20 md:pt-40 lg:pt-16 flex flex-col justify-center">
