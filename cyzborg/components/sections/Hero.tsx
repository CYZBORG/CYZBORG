...
const Hero: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-[55vh] sm:h-[65vh] md:h-[80vh] lg:h-screen w-full flex items-end justify-center z-10 overflow-hidden pt-28 md:pt-36 pb-0">
         <img 
          src="https://helmet-with-logo.netlify.app/cyzborg-helmet.png?v=4" 
          alt="Cyzborg Helmet" 
          className="w-full h-full object-contain object-bottom md:p-0 scale-[1.25] origin-bottom drop-shadow-[0_0_50px_rgba(0,0,0,0.8)] translate-y-4 md:translate-y-8"
         />
      </div>

      {/* VIEWPORT 2: Text Content (Overlaying Image) */}
      <div className="relative z-20 flex flex-col items-center max-w-[90rem] mx-auto text-center pb-8 px-4 -mt-8 sm:-mt-12 md:-mt-20 lg:-mt-24 xl:-mt-28 2xl:-mt-36">
        ...
        <div className="flex flex-col items-center space-y-8 max-w-5xl mb-12 border-y border-neutral-800 py-10 px-6 w-full bg-cyzborg-black/90 backdrop-blur-md shadow-[0_0_30px_rgba(0,0,0,0.5)]">
          ...
          <div className="relative w-full max-w-5xl mx-auto my-4 md:my-8 p-8 md:p-14 bg-black/60 backdrop-blur-lg border border-cyzborg-blue/20 overflow-hidden group shadow-[0_0_40px_rgba(0,174,239,0.1)]">
            ...
            {/* Background Glow */}
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-cyzborg-blue/5 blur-[100px] pointer-events-none"></div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              {/* Main Manifesto */}
              <p className="font-display text-2xl md:text-4xl lg:text-5xl uppercase tracking-widest leading-[1.4] text-neutral-300">
                <img src="https://helmet-with-logo.netlify.app/cyzborg-leds-logo.svg" alt="CYZBORG" className="inline-block h-[0.85em] align-baseline mr-2 md:mr-3" referrerPolicy="no-referrer" /> is an up-and-coming fitness apparel brand creating a <br className="hidden lg:block" />
