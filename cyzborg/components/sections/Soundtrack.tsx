...
const Soundtrack: React.FC = () => {
  ...
  return (
    <section id={SectionIds.SOUNDTRACK} className="pt-8 pb-4 md:pb-6 lg:pb-8 bg-white dark:bg-cyzborg-black relative border-t border-neutral-200 dark:border-neutral-900 overflow-hidden flex items-center scroll-mt-24 md:scroll-mt-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 sm:gap-3 lg:gap-16 items-start">
          ...
          <div className="flex flex-col lg:pr-4 order-3 lg:order-1 relative min-w-0 lg:h-[460px] xl:h-[500px] 2xl:h-[600px]">
            ...
            <div className="flex flex-col justify-start mt-0 flex-grow lg:pb-[60px] relative z-10">
              <div className={`font-sans text-neutral-600 dark:text-neutral-400 text-sm md:text-base lg:text-xl xl:text-2xl 2xl:text-3xl lg:leading-relaxed tracking-wide max-w-lg lg:max-w-2xl text-center lg:text-left mx-auto lg:mx-0 flex flex-col w-full flex-grow mb-6`}>
                {activeTrack.description}
              </div>

              {(activeTrack.spotifyUrl !== '#' || activeTrack.youtubeUrl !== '#' || activeTrack.appleUrl !== '#') && (
                <div className={`border-l-0 lg:border-l-2 border-neutral-200 dark:border-neutral-800 pl-0 lg:pl-5 md:pl-6 relative flex flex-col items-center lg:items-start shrink-0 mt-auto mb-2 md:mb-4 ${activeTrack.id === 'rtg' ? 'lg:mb-[110px]' : 'lg:mb-20'} xl:mb-28 2xl:mb-36`}>
                  ...
                  <div className="font-display text-[13px] sm:text-[15px] md:text-base lg:text-[14px] xl:text-[17px] 2xl:text-[19px] font-black text-black dark:text-white uppercase tracking-wider flex flex-col md:flex-row md:flex-nowrap items-center lg:items-start gap-y-3 md:gap-y-0 gap-x-0 md:gap-x-2 xl:gap-x-3 2xl:gap-x-4 pb-1">
                    ...
                    {(activeTrack.youtubeUrl !== '#' || activeTrack.appleUrl !== '#') && (
                      <span className="hidden md:block text-black dark:text-cyzborg-blue font-bold opacity-70 text-xs lg:text-[10px] xl:text-[11px] shrink-0">•</span> 
                    )}
