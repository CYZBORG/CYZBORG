       ...
       <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-0 md:gap-8 lg:gap-12 items-center">
            ...
            <div className="space-y-6 mb-2 lg:mb-10">
              <div className="space-y-4">
                <p className="font-sans text-neutral-400 text-base md:text-lg lg:text-xl leading-relaxed max-w-xl">
                  CYZBORG launches with premium graphic T-shirts for people who don’t back down. Bold designs. Quality you can feel. A fuck-you attitude toward excuses, comfort zones, and anyone who thinks you should settle.
                </p>
                <p className="font-sans text-neutral-400 text-base md:text-lg lg:text-xl leading-relaxed max-w-xl">
              ...
              <div className="border-l-2 border-cyzborg-orange pl-4 md:pl-5 py-1 mt-8">
                <h4 className="font-sans text-white text-base md:text-lg font-bold uppercase tracking-widest mb-2">PHASE 01: GRAPHIC T-SHIRTS</h4>
                <p className="font-sans text-neutral-400 text-base md:text-lg leading-relaxed max-w-md">
                  Premium CYZBORG graphic T-shirts with bold designs and an attitude that doesn’t back down.
                </p>
              </div>

              <div className="border-l-2 border-cyzborg-blue pl-4 md:pl-5 py-1">
                <h4 className="font-sans text-white text-base md:text-lg font-bold uppercase tracking-widest mb-2">PHASE 02: PERFORMANCE APPAREL</h4>
                <p className="font-sans text-neutral-400 text-base md:text-lg leading-relaxed max-w-md">
                  Premium fitness apparel, headwear, and training gear built for people who expect more from themselves.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative order-1 lg:order-2 flex flex-col items-center justify-center w-full max-w-lg mx-auto lg:max-w-none">
            ...
            {/* Shirt Display Area */}
            <div 
              className="relative w-full aspect-square md:aspect-[4/5] flex items-center justify-center cursor-pointer group mt-0 md:-mt-4 lg:mt-0"
              onClick={() => setIsImageOpen(true)}
            >
              
              <div className="absolute inset-0 flex items-center justify-center p-0 md:p-8 transition-all duration-700">
                <img 
                  loading="lazy" 
                  decoding="async" 
                  src={frontImg}
            ...
            {/* Toggle Controls */}
            <div className="flex items-center gap-2 mt-2 md:-mt-2 lg:mt-4 bg-neutral-900/50 p-1 rounded-sm border border-neutral-800 relative z-10">
              <button 
