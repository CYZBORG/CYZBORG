...
const WhatsComing: React.FC = () => {
  ...
  return (
    <section id={SectionIds.WHATS_COMING} className="pt-8 pb-8 bg-cyzborg-black relative overflow-hidden border-t border-neutral-800 scroll-mt-24 md:scroll-mt-32">
       ...
       {/* Scattered LED Logos */}
       <div className="absolute top-20 -right-[20%] md:-right-[10%] w-[800px] md:w-[1000px] opacity-[0.02] pointer-events-none rotate-12 select-none z-0">
          <img src="https://helmet-with-logo.netlify.app/cyzborg-leds-logo.svg" alt="" className="w-full" />
       </div>
       <div className="absolute bottom-10 -left-[30%] md:-left-[10%] w-[600px] md:w-[800px] opacity-[0.02] pointer-events-none -rotate-12 select-none z-0">
          <img src="https://helmet-with-logo.netlify.app/cyzborg-leds-logo.svg" alt="" className="w-full" />
       </div>
