  ...
  return (
    <section id={SectionIds.WHATS_COMING} className="pt-8 pb-8 bg-cyzborg-black relative overflow-hidden border-t border-neutral-800 scroll-mt-24 md:scroll-mt-32">
       ...
       <div className="absolute top-[50%] left-[50%] w-[600px] md:w-[1000px] opacity-[0.03] pointer-events-none -translate-x-1/2 -translate-y-1/2 rotate-[-5deg] select-none z-0">
          <img src="https://helmet-with-logo.netlify.app/cyzborg-z.svg" alt="" className="w-full" />
       </div>
       ...
       <div className="relative z-10 text-center mb-8 md:mb-16 px-4">
          ...
          <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold text-white uppercase flex flex-wrap justify-center items-center gap-y-2">
            <span className="text-cyzborg-orange">Hardware</span> 
            <span className="text-neutral-600 mx-2 sm:mx-3">&</span> 
            <span className="text-cyzborg-blue">Software</span>
          </h2>
       </div>
