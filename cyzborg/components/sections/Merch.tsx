...
const Merch: React.FC = () => {
  ...
  const getMessage = () => {
    switch (clickCount) {
      case 1: return "I know! We're waiting on our Trademark to Register.";
      case 2: return "Look, I get it. I know you're excited!";
      case 3: return "Just give us more time! I promise!";
      case 4: return "If you really want one right when we launch, drop us a message over on X in the Establish Connection section.";
      default: return null;
    }
  };
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center">
          ...
          <div className="flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1">
            ...
            <p className="font-sans text-neutral-400 text-lg md:text-xl max-w-xl mb-10">
              ...
              <br/>
              <span className="text-sm border-t border-neutral-800 pt-2 mt-4 inline-block">(To Be Determined)</span>
            </p>
            ...
            <div className="flex flex-col items-center lg:items-start gap-4 w-full sm:w-auto">
              ...
              {message && (
                <p className="text-cyzborg-orange font-mono text-xs md:text-sm tracking-widest uppercase animate-fade-in mt-2 text-center lg:text-left">
                  {message}
                </p>
              )}
            </div>
          ...
          <div className="relative order-1 lg:order-2 flex justify-center">
            ...
            <img loading="lazy" decoding="async" 
              src="https://helmet-with-logo.netlify.app/cyzborg-tbd-shirt.svg" 
