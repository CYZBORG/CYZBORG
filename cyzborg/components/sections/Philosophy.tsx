  ...
  return (
    <section id={SectionIds.PHILOSOPHY} className="bg-cyzborg-black py-8 md:py-12 relative border-t border-neutral-900 overflow-hidden scroll-mt-24 md:scroll-mt-32">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* Section Header */}
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 border-b border-neutral-800 pb-4 md:pb-6 gap-4 md:gap-6">
           <div>
             ...
             <div className="font-display text-[14px] sm:text-lg md:text-3xl font-bold uppercase tracking-widest leading-tight whitespace-nowrap">
                <span className="text-cyzborg-blue mr-1.5 md:mr-3">CYZBORG:</span>
                <span className="text-cyzborg-orange mr-1.5 md:mr-3">[CYZ + BORG]</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-7 flex flex-col">
             <div className="border border-neutral-800 bg-neutral-900/30 p-8 md:p-12 h-full relative group transition-colors hover:border-cyzborg-blue/30 hover:bg-neutral-900/50 flex flex-col justify-between overflow-hidden">
                ...
                <div className="relative z-10">
                    ...
                    <h3 className="font-display text-2xl md:text-4xl lg:text-5xl text-white uppercase mb-10 leading-[0.9] font-bold [text-wrap:balance]">
                    ...
                    <div className="font-sans text-neutral-400 text-xl md:text-2xl lg:text-3xl leading-tight tracking-wide uppercase border-l-2 border-neutral-800 pl-6 mb-12 flex flex-col gap-4 group-hover:border-cyzborg-blue/50 transition-colors duration-500">
                        <p className="text-white font-bold mb-2">We're already becoming cyborgs.</p>
                ...
                <div className="bg-neutral-950/80 border border-neutral-800 p-8 relative z-10 backdrop-blur-sm">
                    <p className="font-display text-xl md:text-2xl lg:text-3xl text-cyzborg-blue uppercase leading-tight tracking-wide">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6 md:gap-8">
            ...
            <div className="border border-neutral-800 bg-neutral-900/30 p-8 relative group transition-colors hover:border-cyzborg-blue/50 hover:bg-neutral-900/50 flex-1 flex flex-col justify-center overflow-hidden">
               ...
               <span className="font-mono text-xs md:text-sm text-cyzborg-blue mb-4 block tracking-[0.3em] uppercase relative z-10">
                 ...
                 <p className="font-display text-neutral-300 text-xl md:text-2xl lg:text-[28px] leading-[1.15] tracking-wide uppercase">
                   To us, an <span className="text-white font-bold">AUGMENTED ATHLETE</span> isn't someone with robotic implants <span className="text-neutral-500">(at least not yet 😉).</span> It's someone who embraces technology as a tool for self-improvement.
                 </p>
                 
                 <div className="relative pt-6 border-t border-neutral-800 mt-2">
                   <div className="absolute left-0 top-0 w-12 h-[2px] bg-cyzborg-blue -translate-y-[1px]"></div>
                   
                   <p className="font-sans text-neutral-400 text-xl md:text-2xl lg:text-[22px] leading-relaxed uppercase tracking-[0.15em]">
                     <span className="text-white font-bold tracking-widest">CYZBORG</span> is a brand built for people obsessed with becoming
                   </p>
            ...
            <div className="border border-neutral-800 bg-neutral-950 p-8 relative group transition-colors hover:border-cyzborg-orange/50 overflow-hidden">
               ...
               <div className="font-display text-2xl md:text-3xl lg:text-4xl text-neutral-300 uppercase leading-none space-y-4 mb-4 tracking-wider relative z-10">
          ...
          <div className="lg:col-span-12 border border-neutral-800 bg-neutral-950 p-8 md:p-12 relative group transition-colors hover:border-cyzborg-orange/50 overflow-hidden flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
             ...
             <div className="relative z-10 flex-grow">
               <span className="font-mono text-xs md:text-sm text-cyzborg-orange mb-6 block tracking-[0.3em] uppercase">
                 /// 04_ORIGIN_DATA
               </span>

               <div className="font-display text-2xl md:text-3xl lg:text-4xl text-neutral-400 uppercase leading-none space-y-3 mb-6 md:mb-0 tracking-wider">
                 <p>People exercise.</p>
                 <p>People train with technology.</p>
               </div>
             </div>
             
             <div className="relative z-10 flex flex-col items-center gap-5 border-t md:border-t-0 md:border-l border-neutral-900 pt-6 md:pt-0 md:pl-12">
               <p className="font-display text-xl md:text-2xl text-white uppercase font-bold tracking-widest leading-none text-center">
