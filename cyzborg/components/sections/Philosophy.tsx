          ...
          <div className="lg:col-span-5 flex flex-col gap-6 md:gap-8">
            ...
            <div className="border border-neutral-800 bg-neutral-950 p-8 relative group transition-colors hover:border-cyzborg-orange/50 overflow-hidden">
               ...
               <div className="pt-6 border-t border-neutral-900 relative z-10 flex flex-col gap-1">
                 ...
                 <img loading="lazy" decoding="async" src="https://helmet-with-logo.netlify.app/cyzborg-lightning.svg" alt="CYZBORG" className="h-12 md:h-[60px] object-contain object-left mt-0.5" style={{ filter: 'brightness(0) saturate(100%) invert(35%) sepia(87%) saturate(1476%) hue-rotate(349deg) brightness(88%) contrast(92%)' }} />
               </div>
            </div>
