      ...
      <div className="w-full flex items-center justify-center relative z-10">
        <div className="flex items-center">
          ...
          <div className="flex flex-col text-left">
            <h3 className="font-display text-lg md:text-xl font-bold text-black dark:text-white uppercase tracking-wider mb-0.5 transition-colors">{title}</h3>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          ...
          <SocialCard 
            ...
            hoverBgClass="bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888]"
          />
