...
const SocialCard: React.FC<SocialCardProps> = ({ title, subtitle, href, icon, hoverColorClass, hoverBgClass }) => {
  return (
    <a 
      ...
      className="group relative flex flex-row items-center p-5 md:p-6 bg-neutral-900/40 border border-neutral-800 hover:border-neutral-600 transition-all duration-300 overflow-hidden rounded-md"
    >
      ...
      <div className="w-full flex items-center justify-center relative z-10">
        <div className="flex items-center">
          <div className={`w-10 h-10 md:w-12 md:h-12 flex items-center justify-center shrink-0 mr-4 md:mr-5 bg-neutral-900/80 rounded-md border border-neutral-800 group-hover:border-transparent transition-all duration-300 ${hoverColorClass} group-hover:scale-110`}>
            {icon}
          </div>

          <div className="flex flex-col text-left">
            <h3 className="font-display text-lg md:text-xl font-bold text-white uppercase tracking-wider mb-0.5 group-hover:text-white transition-colors">{title}</h3>
...
const Newsletter: React.FC = () => {
  return (
    <section id={SectionIds.NEWSLETTER} className="pt-8 pb-4 md:py-12 px-4 bg-cyzborg-black relative overflow-hidden border-t border-neutral-900 scroll-mt-24 md:scroll-mt-32">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-8">
          <h2 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold text-white uppercase tracking-tighter leading-none mb-4">
            The Network
          </h2>
          <p className="font-sans text-neutral-400 text-xs md:text-sm uppercase tracking-widest flex items-center justify-center gap-3">
            <span className="w-2 h-2 rounded-full bg-cyzborg-orange animate-pulse shadow-[0_0_8px_#c45a1a]"></span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          <SocialCard 
            ...
            hoverColorClass="text-cyzborg-blue group-hover:text-cyzborg-blue"
          ...
          <SocialCard 
            ...
            hoverColorClass="text-cyzborg-orange group-hover:text-cyzborg-orange"
          ...
          <SocialCard 
            ...
            hoverColorClass="text-white group-hover:text-white"
