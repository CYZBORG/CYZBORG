  ...
  return (
    <div className="fixed bottom-4 left-4 z-50 flex flex-col gap-2">
      ...
      >
        <div className="bg-black w-[280px] h-[157px] sm:w-[320px] sm:h-[180px] relative">
          <iframe
            width="100%"
            height="100%"
            src="https://www.youtube.com/embed/videoseries?list=PLUJrU0jNUfTZBjLYhboB3dDGZj32MFa-K"
      ...
      <div className="flex items-center gap-2">
        ...
        >
          <Radio className={`w-4 h-4 ${isOpen ? 'text-cyzborg-orange' : 'text-neutral-500'}`} />
