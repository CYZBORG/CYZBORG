  ...
  return (
    <header 
      className={`fixed top-0 left-0 w-full z-50 transition-all duration-300 border-b ${
        scrolled 
          ? 'bg-cyzborg-black/90 backdrop-blur-md border-neutral-800 pt-3 pb-1' 
      ...
      <div className="max-w-7xl mx-auto px-6 flex justify-between items-center relative">
        ...
        >
          ...
          <img 
            ...
            alt="CYZBORG" 
            className="h-[60px] md:h-20 w-auto opacity-90 hover:opacity-100 hover:animate-crackle-build transition-opacity duration-300 origin-center"
          />
        </div>
        ...
        <nav className="hidden md:flex items-center gap-10 z-10">
          <button 
            ...
            className="font-sans text-xs uppercase tracking-[0.2em] text-white hover:text-white hover:text-shadow-glow transition-all"
          >
            Audio
          </button>
          <button 
