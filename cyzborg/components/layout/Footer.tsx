...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white dark:bg-cyzborg-black pt-8 pb-12 md:py-12 border-t border-neutral-200 dark:border-neutral-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-center relative z-10">
        ...
        <div className="text-neutral-600 text-[10px] md:text-xs font-sans uppercase tracking-[0.2em] text-center order-3 md:order-2 flex flex-col gap-1.5">
          ...
          <a href="mailto:contact@cyzborg.com" className="hover:text-black dark:hover:text-cyzborg-orange transition-colors mt-1 md:mt-2">CONTACT@CYZBORG.COM</a>
        </div>
        ...
        <div className="flex items-center justify-center md:justify-end gap-6 md:gap-8 order-2 md:order-3">
          ...
          {/* Helmet Logo Link to Apparel */}
          <img loading="lazy" decoding="async" 
            src="https://helmet-with-logo.netlify.app/cyzborg-z.svg" 
            alt="CYZBORG Apparel" 
            onClick={() => document.getElementById('coming-soon')?.scrollIntoView({ behavior: 'smooth' })}
            className="w-auto h-12 md:h-[72px] opacity-90 hover:opacity-100 hover:scale-110 drop-shadow-[0_0_2px_rgba(0,0,0,0.5)] dark:drop-shadow-[0_0_2px_rgba(255,255,255,0.5)] invert dark:invert-0 cursor-pointer transition-all duration-300 mr-2 md:mr-4"
          />

          {/* X (Twitter) - Active */}
          <a href="https://x.com/cyzborg_" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-black dark:hover:text-cyzborg-orange transition-colors" aria-label="X">
          ...
          {/* Instagram */}
          <a href="https://instagram.com/cyzborg" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-black dark:hover:text-cyzborg-orange transition-colors">
             <span className="sr-only">Instagram</span>
            <Instagram className="w-5 h-5" />
          </a>

          {/* TikTok */}
          <a href="https://tiktok.com/@cyzborg" target="_blank" rel="noopener noreferrer" className="text-neutral-500 hover:text-black dark:hover:text-cyzborg-orange transition-colors">
