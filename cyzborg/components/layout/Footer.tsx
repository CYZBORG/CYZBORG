...
const Footer: React.FC = () => {
  return (
    <footer className="bg-cyzborg-black pt-8 pb-12 md:py-12 border-t border-neutral-900 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 items-center relative z-10">
        ...
        >
           <img loading="lazy" decoding="async" 
            src="https://helmet-with-logo.netlify.app/cyzborg-lightning.svg" 
            alt="CYZBORG" 
            className="w-auto h-[60px] md:h-20 opacity-80 hover:opacity-100 hover:animate-crackle-build transition-opacity duration-300 origin-center"
           />
        </div>
        ...
        <div className="text-neutral-600 text-[10px] md:text-xs font-sans uppercase tracking-[0.2em] text-center order-3 md:order-2 flex flex-col gap-1.5">
          ...
          <a href="mailto:contact@cyzborg.com" className="hover:text-cyzborg-orange transition-colors mt-1 md:mt-2">CONTACT@CYZBORG.COM</a>
        </div>
